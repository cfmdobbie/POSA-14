...
public class DownloadBoundServiceAsync extends Service{
    ...
    DownloadRequest.Stub mDownloadRequestImpl = new DownloadRequest.Stub() {
            ...
            public void downloadImage(Uri uri,
            	...
            	// NOTE: Download the file and get the path to the local file
            	String path = DownloadUtils.downloadFile(getApplicationContext(), uri);
            	// NOTE: Send the path back to the caller via the DownloadCallback
            	// reference we received when we were invoked.
